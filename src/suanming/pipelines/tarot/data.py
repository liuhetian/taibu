...
MAJOR_DATA: tuple[
    tuple[str, str, str, str, tuple[str, ...], tuple[str, ...], int], ...
] = (
    ("愚者", "The Fool", "风", "天王星", ("启程", "自由", "信任"), ("冒进", "迷失", "迟疑"), 1),
    ("魔术师", "The Magician", "风", "水星", ("创造", "专注", "行动"), ("操控", "分心", "潜能受阻"), 1),
    ("女祭司", "The High Priestess", "水", "月亮", ("直觉", "静观", "隐秘"), ("忽视直觉", "封闭", "信息不明"), 0),
    ("皇后", "The Empress", "土", "金星", ("丰盛", "滋养", "创造力"), ("过度付出", "依赖", "停滞"), 1),
    ("皇帝", "The Emperor", "火", "白羊座", ("秩序", "责任", "领导"), ("僵化", "控制", "权威冲突"), 0),
    ("教皇", "The Hierophant", "土", "金牛座", ("传统", "学习", "信念"), ("教条", "挑战传统", "价值冲突"), 0),
    ("恋人", "The Lovers", "风", "双子座", ("选择", "联结", "一致"), ("失衡", "分离", "价值不合"), 1),
    ("战车", "The Chariot", "水", "巨蟹座", ("意志", "推进", "胜利"), ("失控", "方向不明", "阻滞"), 1),
    ("力量", "Strength", "火", "狮子座", ("勇气", "耐心", "内在力量"), ("自我怀疑", "冲动", "能量低落"), 1),
    ("隐士", "The Hermit", "土", "处女座", ("内省", "求索", "独立"), ("孤立", "逃避", "拒绝指引"), 0),
    ("命运之轮", "Wheel of Fortune", "火", "木星", ("转机", "周期", "机遇"), ("反复", "延迟", "抗拒变化"), 1),
    ("正义", "Justice", "风", "天秤座", ("公平", "因果", "决断"), ("偏见", "失衡", "逃避责任"), 0),
    ("倒吊人", "The Hanged Man", "水", "海王星", ("暂停", "换位思考", "放下"), ("拖延", "徒劳", "不愿牺牲"), 0),
    ("死神", "Death", "水", "天蝎座", ("结束", "蜕变", "更新"), ("抗拒结束", "停滞", "余波"), 0),
    ("节制", "Temperance", "火", "射手座", ("调和", "耐心", "整合"), ("过度", "失衡", "节奏混乱"), 1),
    ("恶魔", "The Devil", "土", "摩羯座", ("束缚", "欲望", "阴影"), ("松绑", "觉察", "重获自主"), -1),
    ("高塔", "The Tower", "火", "火星", ("突变", "揭露", "结构瓦解"), ("余震", "延缓改变", "危机内化"), -1),
    ("星星", "The Star", "风", "水瓶座", ("希望", "疗愈", "愿景"), ("失望", "信心不足", "愿景模糊"), 1),
    ("月亮", "The Moon", "水", "双鱼座", ("潜意识", "迷雾", "想象"), ("迷雾消散", "压抑", "误判"), -1),
    ("太阳", "The Sun", "火", "太阳", ("活力", "清晰", "成功"), ("短暂低落", "延迟喜悦", "过度乐观"), 1),
    ("审判", "Judgement", "火", "冥王星", ("觉醒", "复盘", "召唤"), ("自我否定", "拒绝复盘", "迟疑"), 0),
        ...
        for rank_id, rank_name, number, upright, reversed_, tone in RANKS:
            cards.append(
                CardDefinition(
                    ...
                    astrology=None,
                    upright=tuple((*suit["themes"][:2], *upright)),
                    reversed=tuple((*suit["shadow"][:2], *reversed_)),
                    base_tone=tone,
                )
            )
    return tuple(cards)
...
SPREADS: dict[str, tuple[str, ...]] = {
    ...
    "choice": ("现状", "选项A优势", "选项A代价", "选项A走向", "选项B优势", "选项B代价", "选项B走向"),
